...
// Executes multiple sql statements as a single atomic action. To guarantee
// that the same connection is used you can wrap multiple statements in a transaction.
//
